...
/* The robot changes the LED it displays based on which sound it hears is most like which preset sound:
 *      Note A1: red
 *      Note B1: green
 *      Note C1: blue
...
public interface TimedLEDState {
    ...
    class StaticLEDState implements TimedLEDState {
        ...
        public static StaticLEDState kMatchingA = new StaticLEDState(LEDState.kRed);
        public static StaticLEDState kMatchingB = new StaticLEDState(LEDState.kGreen);
        public static StaticLEDState kMatchingC = new StaticLEDState(LEDState.kBlue);
